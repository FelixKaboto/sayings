...
public class TextMenu extends JMenu {
	...
	private JRadioButtonMenuItem leftAlignItem;
	...
	public void setDefaults() {
		...
		leftAlignItem.setSelected(true);
	}
	...
	public JMenu makeJustifyMenu() {
		...
		JMenu justifyMenu = new JMenu("Justify Text");
		
		ButtonGroup bg = new ButtonGroup();
		leftAlignItem =  new JRadioButtonMenuItem("Left");
		leftAlignItem.setSelected(true);
		JRadioButtonMenuItem centerAlignItem = new JRadioButtonMenuItem("Center");
		JRadioButtonMenuItem rightAlignItem = new JRadioButtonMenuItem("Right");
		bg.add(leftAlignItem);
		bg.add(centerAlignItem);
		bg.add(rightAlignItem);

	    leftAlignItem.addActionListener(action);
	    rightAlignItem.addActionListener(action);
	    centerAlignItem.addActionListener(action);
		
		justifyMenu.add(leftAlignItem);
		justifyMenu.add(centerAlignItem);
