...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText(
				"C.R.\n" +
				"Vasco da Gama\n" +
				"The Giant of the Hill."
			);
		drawPanel.getTextItem().setFontSize(36);
		drawPanel.getTextItem().setJustify(TextItem.LEFT);
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/vasco.jpeg"));
	...
	private JMenu makeBackgroundMenu() {
		...
		menu.addSeparator();
		menu.add(new ColorIconAction("Color..."));
		menu.addSeparator();
	...
	/*
	 * Create background toolbar
	 */
	private JToolBar makeToolbar() {
		JToolBar tb = new JToolBar(JToolBar.HORIZONTAL);
		tb.add(newPictureAction);
		tb.add(saveImageAction);
		tb.addSeparator();
		tb.add(new ChooseBackgroundAction("Mandelbrot"));
		tb.add(new ChooseBackgroundAction("Earthrise"));
		tb.add(new ChooseBackgroundAction("Sunset"));
		tb.add(new ChooseBackgroundAction("Cloud"));
		tb.add(new ChooseBackgroundAction("Eagle_nebula"));
		tb.add(new ChooseBackgroundAction("Custom..."));
		tb.add(new ColorIconAction("Color..."));
		return tb;
	}
	...
	private class ColorIconAction extends AbstractAction {
			ColorIconAction(String text) {
				super(text);
				...
				g.fillRect(1, 0, 10, 32);
				g.setColor(Color.GREEN);
				g.fillRect(11, 0, 10, 32);				
				g.setColor(Color.BLUE);
				g.fillRect(21, 0, 10, 32);
				g.dispose();
