...
public class IconSupport {
	...
	public IconSupport(DrawPanel owner) {
		panel = owner;
		String[] iconNames = { "bell", "camera", "flower", "star", "check", "crossout", "tux", "bomb", "keyboard",
				"lightbulb", "tv" };
	 ...
	 * 
	 * @param horizontal
	 *            a value of JToolBar.HORIZONTAL or JToolBar.VERTICAL tells whether
	 *            the toolbar is meant to have horizontal or vertical orientation.
	 */
